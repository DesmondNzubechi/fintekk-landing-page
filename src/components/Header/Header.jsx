    ...
    return(
        <div className="py-[70px] px-[40px] gap-[130px] flex flex-col md:flex-row justify-center ">
            <div className="flex flex-col gap-[10px]">
                <h1 className="font-[500] text-[50px] w-[503px] text-[#172E80] ">Pay, Invest, Save your Cash with a single bank</h1>
                <p className="text-[24px] text-[#777777]  w-[503px] font-[399] ">Fintekk is the bank that does it all. Manage everything directly and easy with fintekk.</p>
              <button className="bg-[#2E5CFF] ronded-[16px] px-[24px] py-[16px] w-fit text-[#fff] text-[20px] rounded-2xl ">Sign Up for Free</button>
              <div className="flex flex-row gap-[20px] py-[10px] items-start ">
            ...
            <div className=" relative h-[500px]  max-w-[500px] ">
              ...
              <span className="absolute flex shadow-xl shadow-paymenshadow gap-[20px] flex-row items-center rounded-xl top-[200px] p-[10px] left-[-140px] bg-[#fff] ">
          <FaTelegramPlane className="bg-payment rounded text-[40px] text-[#5BCDF0] p-[10px] "/>
          <span className="flex flex-col gap-[5px] ">
            <p className="text-[#172E80] text-[16px] ">Payment</p>
            <span className="bg-[#F4F6FF] flex p-[-20px] h-[10px] rounded-full w-[119px] ">
                <span className="bg-[#5BCDF0] w-[80%] h-[10px] rounded-full "></span>
            </span>
          </span>
              </span>

              <span className="absolute flex shadow-xl  shadow-savingshadow gap-[20px] flex-row items-center rounded-xl top-[114px] p-[10px] right-[-70px] bg-[#fff] ">
          <BsPiggyBankFill className="bg-saving rounded text-[40px] text-[#FF61EF] p-[10px] "/>
          <span className="flex flex-col gap-[5px] ">
            <p className="text-[#172E80] text-[16px] ">Savings</p>
            <span className="bg-[#F4F6FF] flex p-[-20px] h-[10px] rounded-full w-[119px] ">
          ...
          <BiBarChart className="bg-investment rounded text-[40px] text-[#605EFB] p-[10px] "/>
          <span className="flex flex-col gap-[5px] ">
