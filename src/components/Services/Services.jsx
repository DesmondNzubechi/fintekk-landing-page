    ...
    return (
        <div className="bg-[#FBFBFB] py-[50px] px-[20px] ">
            <div className="flex flex-col items-center justify-center text-center ">
                ...
                <div>
                <p className=" text-center flex justify-center text-[20px] text-[#777777]  font-[300] max-w-[700px] ">We help individuals become more flexible and responsible with their finances and handle  payments smooth and easy. </p>
                </div>
               </div>
            <div className="flex justify-center items-center mt-[30px] gap-[40px] flex-col md:flex-row  ">
                <div className="bg-[#F4F6FF] p-[20px] min-h-[400px] max-w-[368px] flex flex-col rounded-[30px] justify-center items-center ">
                ...
                <div className="bg-[#FEF7F1] p-[20px] flex flex-col rounded-[30px] max-w-[368px] min-h-[400px] justify-center items-center ">
                    <div className="flex flex-col items-start gap-[10px] ">
                ...
                <div className="bg-[#F4F6FF] p-[20px] flex flex-col max-w-[368px]  min-h-[400px] rounded-[30px] justify-center items-center ">
                    <div className="flex flex-col items-start gap-[10px] ">
